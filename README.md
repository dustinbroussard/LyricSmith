...
A **modern, touch-friendly web app** for musicians to manage setlists and lyrics with zero clutter and maximum clarity. Designed for live band rehearsals, gigging, and on-stage editor. Fast, offline-first, and fully mobile/tablet-friendly.
...
- **Light/Dark themes**: AMOLED Dark (default) and Light. Toggle instantly—even during editor.
...
- Tap a song or click **Start** to enter editor mode.
- In editor mode:
...
- Pick a setlist and enter editor mode.
